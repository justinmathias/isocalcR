#' @title d13C.to.Ci
#'
#' @description Calculates leaf intercellular CO2 concentration given plant tissue d13C signature. Defaults to the 'simple' formulation (See Lavergne et al. 2022) and 'leaf' tissue to calculate leaf Ci. Under the 'simple' formulation the apparent fractionation by Rubisco is 27 permille if from 'leaf' tissue and 25.5 permille if from wood tissue (Cernusak and Ubierna 2022).
#'
...
#'
#' @return The concentration of leaf internal CO2 (ppm)
#'
#' @references
...
#'
#' @examples
#' d13C.to.Ci(d13C.plant = -27, year = 2015, elevation = 900, temp = 24, method = "simple", tissue = "leaf")
#' d13C.to.Ci(d13C.plant = -27, year = 2015, elevation = 900, temp = 24, method = "simple", tissue = "wood")
#' d13C.to.Ci(d13C.plant = -27, year = 2015, elevation = 900, temp = 24, method = "photorespiration")
#'
#'
#'
d13C.to.Ci <- function(d13C.plant, year, elevation, temp, method = "simple", tissue = "leaf", frac = 0) {
