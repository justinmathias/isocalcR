#' @title d13C.to.Ci
#'
#' @description Calculates leaf intercellular CO2 concentration given plant tissue d13C signature. Defaults to the 'simple' formulation to calculate leaf Ci (See Lavergne et al. 2022).
#'
...
#'
#'
d13C.to.Ci <- function(d13C, year, elevation, temp, method = "simple", frac = 0) {
