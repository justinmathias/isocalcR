#' @title d13C.to.Ci
#'
#' @description Calculates leaf intercellular CO2 concentration given plant tissue d13C signature.
#'
...
#'
#' @return The concentration of leaf intercellular CO2 (Ci) in parts per million (ppm)
#'
#' @references
...
#'
#'
d13C.to.Ci <- function(d13C, year, elevation, temp, frac = 0) {
  ...
  b <- 25.5 #Fractionation associated with Rubisco carboxylation, Cernusak and Ubierna 2022.
