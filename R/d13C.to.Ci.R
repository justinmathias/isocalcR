...
#'
#' @examples
#' d13C.to.Ci(d13C = -27, year = 2015, elevation = 900, temp = 24, method = "simple", tissue = "leaf")
#' d13C.to.Ci(d13C = -27, year = 2015, elevation = 900, temp = 24, method = "simple", tissue = "wood")
#' d13C.to.Ci(d13C = -27, year = 2015, elevation = 900, temp = 24, method = "photorespiration")
#'
#'
#'
d13C.to.Ci <- function(d13C, year, elevation, temp, method = "simple", tissue = "leaf", frac = 0) {
